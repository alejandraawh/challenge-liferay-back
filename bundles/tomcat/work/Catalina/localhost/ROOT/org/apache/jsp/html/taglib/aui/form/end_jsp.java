...
private static HashMap<String, Object> _toHashMap(Object obj) {
  ...
  static {
    ...
    _jspx_dependants.put("/html/taglib/aui/form/init.jsp", Long.valueOf(1694848796668L));
    ...
    _jspx_dependants.put("/html/taglib/aui/form/init-ext.jspf", Long.valueOf(1698433025330L));
  }
  ...
  static {
    ...
    _jspx_imports_classes = new java.util.LinkedHashSet<>(215);
    ...
    _jspx_imports_classes.add("com.liferay.portal.kernel.servlet.taglib.aui.ValidatorTag");
...
Map<String, List<ValidatorTag>> validatorTagsMap = (Map<String, List<ValidatorTag>>)request.getAttribute("LIFERAY_SHARED_aui:form:validatorTagsMap");
      ...
      out.write('	');
if (
 (checkboxNames != null) && !checkboxNames.isEmpty() ) {
      out.write('\n');
      out.write('	');
      out.write('	');
      //  aui:input
      ...
      // /html/taglib/aui/form/end.jsp(11,2) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_aui_005finput_005f0.setName("checkboxNames");
      // /html/taglib/aui/form/end.jsp(11,2) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_aui_005finput_005f0.setType("hidden");
      // /html/taglib/aui/form/end.jsp(11,2) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_aui_005finput_005f0.setValue( StringUtil.merge(checkboxNames) );
...
String fullName = namespace + HtmlUtil.escapeJS(name);
      ...
      // /html/taglib/aui/form/end.jsp(23,0) name = use type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (
 validatorTagsMap != null ) {
          ...
          out.print( HtmlUtil.escapeJS(validatorTag.getName()) );
          out.write("'\n");
          out.write("							}\n");
          out.write("\n");
          out.write("					");
...
if (
 Validator.isNotNull(onSubmit) ) {
          ...
          out.write("') {\n");
          out.write("			delete Liferay.Form._INSTANCES['");
          out.print( fullName );
          out.write("'];\n");
          out.write("		}\n");
          out.write("	};\n");
